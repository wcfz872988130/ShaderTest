Shader "WCH/VertexColorTransform" {
    Properties 
    {
        ...
        _WaveStrenth("Wave Strenth", Float) = 0.05
    ...
    SubShader 
    {
        ...
        VertexOutput vert(VertexInput v)
        {
            ...
            half dist = distance(_StartPos.xyz, mul(_Object2World, v.vertex).xyz);//mul(_Object2World,v.vertex)本地顶点坐标转换为世界坐标
            ...
            x = saturate(x*0.25+0.5);//如果函数里面的值小于0，则该值为0.如果函数里面的值大于1，则该值为1.
